...
<template>
  <header class="flex items-center justify-between py-4 mb-6">
    <div class="flex items-center gap-2 sm:gap-3">
      <div
        class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center transition-all duration-200 hover:scale-110 hover:shadow-glow cursor-pointer"
      >
        <svg
          class="w-4 h-4 sm:w-6 sm:h-6 text-white transition-transform duration-200 hover:rotate-45"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          stroke-width="2"
      ...
      <h1
        class="text-xl sm:text-2xl font-bold text-gradient header-title transition-all duration-200 hover:scale-105 cursor-pointer"
      >
        Lens Tracking
      </h1>
    </div>
