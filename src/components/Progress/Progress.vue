...
<template>
  <div
    class="flex flex-col items-center gap-4 p-4 sm:p-6 bg-card rounded-xl shadow-sm animate-fade-in progress-container card-hover"
  >
    <div class="relative">
      ...
      <div v-if="!hasLenses" class="w-28 h-28 sm:w-32 sm:h-32 flex items-center justify-center">
        <div class="text-center">
          <div
            class="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 rounded-full bg-muted flex items-center justify-center transition-all duration-200 hover:bg-primary hover:text-primary-foreground"
          >
            <svg
